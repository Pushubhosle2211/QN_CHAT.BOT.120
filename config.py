...
OWNER_ID = int(getenv("OWNER_ID", "1476655690"))
MONGO_URL = getenv("MONGO_URL", None)
SUPPORT_GRP = getenv("SUPPORT_GRP", "QUEEN_SUPPORTS_CHAT)
UPDATE_CHNL = getenv("UPDATE_CHNL", "TheQueenUpdates")
OWNER_USERNAME = getenv("OWNER_USERNAME", "EBD_QN")
